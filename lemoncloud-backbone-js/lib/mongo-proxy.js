...
module.exports = function(p, i) {
  ...
  var makeScrollBarDecorator = function() {
    if (!was_new) {
      throw new Error("env:GS_ENDPOINT is required!");
    }
    var index = "X" + i;
    var r = p(index);
